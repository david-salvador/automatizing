...
# called __init__.py. This file can be empty, and it indicates that the directory
...
# module inside that package called bar. We also must not forget to add the __init__.py
